        ...
        <>
...

            {
                props.step.fieldType == 'file' ?
                    <AuthImageInput key={`input-${props.index}`} handleInputValue={props.handleInput} id={props.step.fieldId} type={props.step.fieldType} value={props.form[props.step.fieldId]} />
                    :
                    <></>
            }
        </>
