...
interface Props {
    setAddingNewAdventure: (value: boolean) => void;
}

const NewAdventureCard = (props: Props) => {
    return (
        <div className='w-[306px] min-h-[474px] h-full rounded-[20px]'>
            <button onClick={() => { props.setAddingNewAdventure(true) }} className="w-full rounded-[20px] h-full cursor-pointer hover:bg-neutral/10  bg-base300/49 border border-base-content/29  text-base-content/23 flex justify-center items-center flex-col gap-4">
