...
const PagelayoutAuth = (props: Props) => {
    return (
        <div className={`flex ${props.right ? '' : 'flex-row-reverse'} bg-base200 min-h-screen w-full font-poppins overflow-x-hidden`}>
            <Menu />
            ...
            <div className={`hidden lg:flex flex-col gap-[30px] lg:w-1/2 xl:w-1/2 2xl:w-3/5 bg-cover text-white pt-[150px] ${props.right ? 'pe-0 items-end lg:pe-[80px] 2xl:pe-[150px]' : 'ps-0 items-start lg:ps-[80px] 2xl:ps-[150px]'}`} style={{ backgroundImage: `url('${props.right ? WaveImage : WaveReverseImage}')` }}>
